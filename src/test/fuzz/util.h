 ...
 */
[[nodiscard]] bool OpenDataTraceStream() noexcept;
 ...
 */
template <typename T>
[[nodiscard]] bool WriteToDataStream(const T& obj) noexcept
{
 ...
 */
#define SERIALIZE_TO_DATATRACE(obj) WriteToDataStream(obj)
